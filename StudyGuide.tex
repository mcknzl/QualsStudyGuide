...
$$\mu_{mix} = \sum\mu_i=\sum\nu_i\mu_i^0 + R_uT\sum\ln\left(\frac{p_i}{p^0}\right)$$
$$R_uT\sum\ln\left(\frac{p_i}{p^0}\right)=R_uT\ln\left(\prod\frac{p_i}{p^0}\right)=R_uT\ln(K_p)$$
$$\mathrm{Equilibrium}\implies d\mu_{mix}=0=d\left(\sum\nu_i\mu_i^0 + R_uT\ln(K_p)\right)$$
...
$$\frac{d}{dT}\left(\frac{\mu_i^0}{T}\right) = \frac{-\hat{h}_i}{T^2}$$
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.75]{Graphics/maxwellian_dist.png}
\end{figure}
